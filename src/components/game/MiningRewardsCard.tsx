      ...
      <div className="relative bg-[#111118] border border-gray-700 rounded-2xl p-6 w-full max-w-sm mx-4 shadow-2xl">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 py-2 rounded-lg bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
          >
            {saving ? 'Saving...' : 'Save'}
          </button>
        </div>
